...
statewide_disposal_with_proportions <- statewide_disposal_raw %>%
  left_join(ca_disposed_resin_proportions, by = "county")
...
county_disposal_by_sector <- statewide_disposal_with_proportions %>%
  mutate(
    ...
    ldpe_lldpe_tons_sector = ldpe_lldpe_tons * ldpe_lldpe,
  ...
  select(
    ...
    pet_tons_sector, hdpe_tons_sector, pp_tons_sector, ldpe_lldpe_tons_sector, pvc_tons_sector, other_resins_tons_sector, ps_tons_sector
  )
...
```{r}
write_xlsx(list("County Sector Resin 2014" = sector_disposed_resin_df,"County Sector Resin Proportions" = sector_disposed_resin_proportions, "County Year Resin" = statewide_disposal_raw,"Sector County Year Resin"=county_disposal_by_sector), here("processed data/Disposed Waste by Sector County Year Resin.xlsx"))
```
...
# Stacked bar plot of resin distribution by sector in 2020
